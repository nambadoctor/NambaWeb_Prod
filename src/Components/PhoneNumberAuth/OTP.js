...
import { SetOtpAction } from '../../actions/LoginActions';
                ...
                onChange={(event) => {
                    if (isNumeric(event.target.value)) {
                        ...
                        if (event.target.value.length > 1) {
                            ...
                            dispatch(
                                SetOtpAction(otp.slice(0, 1) + otp.slice(2)),
                            );
                            ref0.current.focus();
                        }
                    }
                ...
                onChange={(event) => {
                    if (isNumeric(event.target.value)) {
                        ...
                        if (event.target.value.length > 1) {
                            ...
                            dispatch(
                                SetOtpAction(otp.slice(0, 2) + otp.slice(3)),
                            );
                            ref1.current.focus();
                        }
                    }
                ...
                onChange={(event) => {
                    if (isNumeric(event.target.value)) {
                        ...
                        if (event.target.value.length > 1) {
                            ...
                            dispatch(
                                SetOtpAction(otp.slice(0, 3) + otp.slice(4)),
                            );
                            ref2.current.focus();
                        }
                    }
                ...
                onChange={(event) => {
                    if (isNumeric(event.target.value)) {
                        ...
                        if (event.target.value.length > 1) {
                            ...
                            dispatch(
                                SetOtpAction(otp.slice(0, 4) + otp.slice(5)),
                            );
                            ref3.current.focus();
                        }
                    }
