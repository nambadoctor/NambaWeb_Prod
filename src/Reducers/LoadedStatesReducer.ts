...
export const LoadedStatesReducer = (
    state: LoadedState = initialState,
    action: Action,
): LoadedState => {
    SetTrackTrace(
        'Entered Loaded States Reducer: ' + action.type,
        'LoadedStatesReducer',
    ...
    switch (action.type) {
        case LoadedStatesReducer_Types.SET_INITIAL_START_LOAD_TIME_STATE:
            SetTrackTrace(
                'Entered Loaded States Reducer SET_INITIAL_START_LOAD_TIME_STATE SUCCESS',
                'LoadedStatesReducer',
                SeverityLevel.Information,
            );
            return {
        ...
        case LoadedStatesReducer_Types.SET_SERVICE_PROVIDER_BASIC_LOADED_STATE:
            SetTrackTrace(
                'Entered Loaded States Reducer SET_SERVICE_PROVIDER_BASIC SUCCESS',
                'LoadedStatesReducer',
                SeverityLevel.Information,
            );
            return {
        ...
        case LoadedStatesReducer_Types.SET_CURRENT_SERVICE_PROVIDER_LOADED_STATE:
            SetTrackTrace(
                'Entered Loaded States Reducer SET_CURRENT_SERVICE_PROVIDER SUCCESS',
                'LoadedStatesReducer',
                SeverityLevel.Information,
            );
            return {
        ...
        case LoadedStatesReducer_Types.SET_APPOINTMENTS_LOADED_STATE:
            SetTrackTrace(
                'Entered Loaded States Reducer SET_APPOINTMENTS SUCCESS',
                'LoadedStatesReducer',
                SeverityLevel.Information,
            );
            return {
        ...
        case LoadedStatesReducer_Types.SET_CUSTOMERS_LOADED_STATE:
            SetTrackTrace(
                'Entered Loaded States Reducer SET_CUSTOMERS SUCCESS',
                'LoadedStatesReducer',
                SeverityLevel.Information,
            );
            return {
        ...
        default:
            SetTrackTrace(
                'Loaded States Reducer Hits default switch: Returns original state',
                'LoadedStatesReducer',
                SeverityLevel.Error,
            );
            return state;
