...
export const uiTriggerReducer = (
    state: UITriggerState = initialState,
    action: Action,
): UITriggerState => {
    SetTrackTrace(
        'Entered UI Trigger Reducer: ' + action.type,
        'UiTriggerReducer',
    ...
    switch (action.type) {
        case UITrigger_Types.SET_ORG_PICKER_MODAL_TOGGLE:
            SetTrackTrace(
                'UI Trigger Reducer SET_ORG_PICKER_MODAL_TOGGLE SUCCESS' +
                    action.payload,
                'UiTriggerReducer',
                SeverityLevel.Information,
            );
        ...
        case UITrigger_Types.SET_SHOW_LINEAR_LOADING_BAR_TOGGLE:
            SetTrackTrace(
                'UI Trigger Reducer SET_SHOW_LINEAR_LOADING_BAR_TOGGLE SUCCESS' +
                    action.payload,
                'UiTriggerReducer',
                SeverityLevel.Information,
            );
        ...
        case UITrigger_Types.SET_FATAL_ERROR:
            SetTrackTrace(
                'UI Trigger Reducer SET_FATAL_ERROR SUCCESS' + action.payload,
                'UiTriggerReducer',
                SeverityLevel.Information,
            );
            return {
        ...
        case UITrigger_Types.SET_NON_FATAL_ERROR:
            SetTrackTrace(
                'UI Trigger Reducer SET_NON_FATAL_ERROR SUCCESS' +
                    action.payload,
                'UiTriggerReducer',
                SeverityLevel.Information,
            );
        ...
        default:
            SetTrackTrace(
                'UI Trigger Reducer Hits default switch: Returns original state',
                'UiTriggerReducer',
                SeverityLevel.Error,
            );
            return state;
