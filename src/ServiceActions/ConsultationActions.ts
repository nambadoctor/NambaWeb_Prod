...
import { SetCustomer, SetPrescriptions, SetReports } from "../Actions/CurrentCustomerActions";
  ...
  (): ThunkAction<void, RootState, null, Action> =>
    async (dispatch, getState) => {
      ...
      const currentAppointmentReports =
        getState().ConsultationState.Reports!;
      ...
      if (response) {
        ...
        dispatch(SetReports(allReportsToSet));
      } else {
  ...
  (): ThunkAction<void, RootState, null, Action> =>
    async (dispatch, getState) => {
      ...
      const currentAppointmentPrescriptions =
        getState().ConsultationState.Prescriptions;
      ...
      if (response) {
        ...
        dispatch(SetPrescriptions(allPrescriptionsToSet));
      } else {
