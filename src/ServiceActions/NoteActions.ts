...
export const GetNotes =
    ...
    async (dispatch, getState) => {
        ...
        try {
            ...
            dispatch(
                SetNonFatalError('Could not get notes for this appointment'),
            );
        }
    };

export const GetAllNotesForCustomer =
    (
    ...
    async (dispatch, getState) => {
        try {
            let response = await getCall(
                {} as Array<INoteIncomingData>,
                GetCustomerAllNotesEndPoint(organisationId, customerId),
                'GetAllNotes',
            );
