...
import { DeleteCustomerNoteEndPoint, GetCustomerAllNotesEndPoint, GetCustomerNotesEndPoint, SetCustomerNoteEndPoint, SetCustomerStrayNoteEndPoint } from "../Helpers/EndPointHelpers";
...
export const UploadStrayNote = (note: INoteOutgoingData): ThunkAction<void, RootState, null, Action> => async (dispatch, getState) => {
    ...
    try {
        let response = await postCall({} as any, SetCustomerStrayNoteEndPoint(
