...
const SetAddPatientIsCheckingForCustomer = (
    isCheckingForCustomer: boolean,
): Action => SetAddPatientIsCheckingForCustomerAction(isCheckingForCustomer);

const SetAddPatientIsCustomerExists = (isCustomerExists: boolean): Action =>
    SetAddPatientIsCustomerAction(isCustomerExists);

const SetAddPatientIsInvalidNumber = (isInvalidNumber: boolean): Action =>
    SetAddPatientIsInvalidNumberAction(isInvalidNumber);
