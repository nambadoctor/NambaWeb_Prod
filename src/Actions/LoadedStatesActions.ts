...
import { LoadedState, LoadedStatesReducer_Types } from "../Reducers/LoadedStatesReducer";
...
export const SetInitialLoadingStartTime = (): ThunkAction<void, RootState, null, Action> => async (dispatch, getState) => {
    dispatch(setDatePayload(new Date(), LoadedStatesReducer_Types.SET_INITIAL_START_LOAD_TIME_STATE));
}
